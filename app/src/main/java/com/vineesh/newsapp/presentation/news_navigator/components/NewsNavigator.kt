package com.vineesh.newsapp.presentation.news_navigator.components
...
fun NewsNavigator() {
    ...
    selectedItem = when (backStackState?.destination?.route) {
        Route.HomeScreenScreen.route -> 0
    ...
    val isBottomBarVisible = remember(key1 = backStackState) {
        backStackState?.destination?.route == Route.HomeScreenScreen.route ||
    ...
    Scaffold(modifier = Modifier.fillMaxSize(), bottomBar = {
                ...
                onItemClick = { index ->
                    when (index) {
                        0 -> navigateToTab(
                            ...
                            route = Route.HomeScreenScreen.route
                        )
        ...
        NavHost(
            ...
            composable(route = Route.HomeScreenScreen.route) { backStackEntry ->
